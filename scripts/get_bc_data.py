...
image = np.load(f"{data_dir}images/data.npy")
...
plt.axis("off")
plt.legend(handles=patches, loc=8, ncol = 3, fontsize='small', borderaxespad=-3.25, columnspacing = 1.35)
plt.savefig(
    f"{images_dir}test_gt.eps",
    bbox_inches="tight",
    pad_inches=0,
    dpi=500,
)
